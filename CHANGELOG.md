...
### Fixed
- Security: Prevent path traversal attacks in playlist zip extraction
- Security: Validate file paths from playlist database before access
- Security: Sanitize filenames to remove unsafe characters
- Use UUID for imported filenames to prevent collisions
